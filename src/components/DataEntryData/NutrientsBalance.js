...
const NutrientBalance = () => {
  ...
  return (
    <form onSubmit={handleSubmit}>
      <div className="mb-4">
        <h1 className="font-bold">Nutrient Balance</h1>
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label htmlFor="calcium" className="mb-2 block">
              I. Available Calcium (ppm)
            </label>
            <input
              type="text"
              id="calcium"
